            ...
            >
                ...
                <div className="w-[95%] mx-auto flex flex-col gap-2 h-full p-4 rounded-lg">
                    ...
                    <div className="flex justify-center">
                        <span className="w-full flex justify-center items-center gap-2 bg-[#FF383B] border border-[#FF383B] text-white font-semibold text-[12px] md:text-[14px] px-[12px] py-[8px] rounded-[8px]">
