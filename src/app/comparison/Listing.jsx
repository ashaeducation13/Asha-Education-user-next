    ...
    <>
      <section className="containers border-b border-b-[#E1E4ED]">
        ...
        <div className="mx-auto grid md:grid-cols-[25%_1fr] gap-[10px] pt-5 pb-10">
          ...
          <div>
            {/* Mobile heading */}
            <h2 className="text-[14px] md:text-[16px] lg:text-[20px] font-semibold md:hidden">
              Specialisations
            </h2>
            
            {/* MD+ heading - moved up before comparedLogos */}
            <h2 className="hidden md:block text-[14px] md:text-[16px] lg:text-[20px] font-semibold mb-3">
              Specialisations
            </h2>
