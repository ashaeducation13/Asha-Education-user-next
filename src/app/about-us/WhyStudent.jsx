  ...
  return (
    <section className="containers relative py-3 md:py-6 text-[#121212] ">
      <motion.h2
        ...
        viewport={{ once: true }} className="font-open-sans lg:text-[40px] md:text-[32px] text-[21px] whitespace-nowrap leading-[40px] font-semibold md:mb-5 ">
      ...
      {/* <motion.p
        ...
        viewport={{ once: true }} className="font-rubik text-[#121212] lg:text-[16px] md:text-[14px] text-[12px] font-normal lg:leading-[24px] md:leading-[21px] leading-[156%] md:mb-8 mb-4">
      ...
      <motion.p
        ...
        transition={{ duration: 0.8, delay: 0.2 }}
        viewport={{ once: true }} className="font-rubik text-[#121212] lg:text-[16px] md:text-[14px] text-[12px] font-normal lg:leading-[24px] md:leading-[21px] leading-[156%] md:mb-8 mb-4">
        We specialize in creating inclusive, innovative, and impactful learning experiences that meet the demands of today’s fast-changing world. Whether you're preparing for higher education, aiming for professional growth, or seeking personal enrichment, Asha Education stands by your side—every step of the way.
