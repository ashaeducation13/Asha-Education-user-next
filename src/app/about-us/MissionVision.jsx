...
function MissionVision({data}) {
  ...
  return (
    <section className="containers grid grid-cols-1 md:grid-cols-3 flex-wrap justify-center xl:gap-10 gap-2 md:gap-4 lg:gap-6 lg:pt-14 md:pt-12 md:pb-5 lg:pb-10 pt-5 pb-3 px-4">
      {cardData.map((card)=> (
        <div
