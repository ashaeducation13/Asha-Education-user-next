    ...
    <footer className="lg:pt-12 md:pt-8 pt-6 pb-8">
      <div className="containers md:mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-[1fr_0.5fr_1.5fr_1.5fr]  lg:grid-cols-[1fr_0.75fr_1.5fr_1fr] gap-4 lg:gap-6">
          ...
          >
            {/* Logo */}
            <Image src={logo} alt="Logo" className="h-[45px] w-[100px]" />

            <p className="font-rubik text-[12px] md:text-[14px] lg:text-[16px] text-[#6D758F] font-normal">
              We guide students with expert counselling, top university
              partnerships, and successful career placements.
            </p>

            <div className="space-y-4">
              <h3 className="text-[#6D758F] text-[12px] md:text-[14px] lg:text-[16px] font-open-sans font-semibold">
            ...
            <div className="flex space-x-4 pt-4">
              {/* Facebook */}
              <a href="https://www.facebook.com/share/1RzdJHpNed/?mibextid=wwXIfr" className="hover:opacity-80">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-[14px] lg:text-[16px] font-medium mb-4">
              Quick Links
            </h3>
            ...
            <ul className="space-y-4 text-[14px] lg:text-[16px]">
              ...
              <li className="flex items-start gap-2">
                ...
                <div className="text-[#6D758F] w-full">
                  ...
                  <div className="font-semibold">{aboutus.address}</div>
                </div>
              </li>
              ...
              <li className="flex items-start gap-2">
                ...
                <div className="text-[#6D758F] flex flex-col w-[75%]">
                  ...
                  <a
                    ...
                    className="font-semibold transition duration-300 break-words"
                  >
                    {aboutus.email}
                  </a>
                </div>
        ...
        <motion.div
          ...
          transition={{ duration: 0.6 }}
          viewport={{ once: true }}
          className="pt-8 mt-8 text-center text-black font-medium text-sm flex flex-wrap items-center gap-x-4 gap-y-2 max-w-3xl mx-auto lg:max-w-full lg:justify-between"
        >
          ...
          <p className="inline-flex items-center w-full sm:w-auto justify-center sm:justify-start lg:w-auto">
            ...
            <a
              ...
              className="text-[#FF383B] font-medium ml-1 mr-1"
            >
