            ...
            <div >
                <Link href={`/programs?${id}`} passHref>
                    ...
                    <motion.h2
                        ...
                        className={`absolute font-bold text-[14px] md:text-[16px] lg:text-[24px] z-16 leading-[14px] md:leading-[16px] lg:leading-[26px] transition-all duration-300 ease-in-out 
